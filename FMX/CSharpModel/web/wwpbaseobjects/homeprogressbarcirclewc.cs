/*
       ...
       Generated on: 7/11/2019 12:29:20.52
...
namespace GeneXus.Programs.wwpbaseobjects {
   public class homeprogressbarcirclewc : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void RenderHtmlCloseForm0H2( )
      {
         ...
         {
            context.AddJavascriptSource("wwpbaseobjects/homeprogressbarcirclewc.js", "?201971112292062", false, true);
         }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?201971112292095", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("wwpbaseobjects/homeprogressbarcirclewc.js", "?201971112292095", false, true);
            context.AddJavascriptSource("DVelop/Bootstrap/DVProgressIndicator/DVProgressIndicatorRender.js", "", false, true);
         }
