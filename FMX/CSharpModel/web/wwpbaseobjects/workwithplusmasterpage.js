/*!   GeneXus C# 16_0_2-131213 on 7/12/2019 10:19:35.84
*/
...
gx.define('wwpbaseobjects.workwithplusmasterpage', false, function () {
   ...
   DDO_ADMINAG_MPAGEContainer.addEventHandler("OnOptionClicked", this.e150l1_client);
   ...
   GXValidFnc[22]={ id: 22, fld:"SHOWMENU",grid:0,evt:"e140l1_client"};
   ...
   this.AV5AdminAGData = [ ] ;
   this.AV8DVelop_Menu = [ ] ;
   this.Events = {"e160l2_client": ["ENTER_MPAGE", true] ,"e170l2_client": ["CANCEL_MPAGE", true] ,"e150l1_client": ["DDO_ADMINAG_MPAGE.ONOPTIONCLICKED_MPAGE", false] ,"e140l1_client": ["DOSHOWMENU_MPAGE", false]};
