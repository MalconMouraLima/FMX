/*
       ...
       Generated on: 7/11/2019 12:29:29.35
...
namespace GeneXus.Programs {
   public class produtoview : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public produtoview( )
      {
      ...
      public void execute( short aP0_ProdutoId ,
                           String aP1_TabCode )
      {
         this.AV9ProdutoId = aP0_ProdutoId;
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            {
               AV9ProdutoId = (short)(NumberUtil.Val( gxfirstwebparm, "."));
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV9ProdutoId", StringUtil.LTrim( StringUtil.Str( (decimal)(AV9ProdutoId), 4, 0)));
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "gxhash_vPRODUTOID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV9ProdutoId), "ZZZ9"), context));
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?201971112292937", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("produtoview.aspx") + "?" + UrlEncode("" +AV9ProdutoId) + "," + UrlEncode(StringUtil.RTrim(AV7TabCode))+"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vPRODUTOID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV9ProdutoId), 4, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vPRODUTOID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV9ProdutoId), "ZZZ9"), context));
      ...
      {
         return formatLink("produtoview.aspx") + "?" + UrlEncode("" +AV9ProdutoId) + "," + UrlEncode(StringUtil.RTrim(AV7TabCode)) ;
      }
      ...
      protected void WB0Q0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblWorkwithlink_Internalname, "Ir a Produto", lblWorkwithlink_Link, "", lblWorkwithlink_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockLink", 0, "", 1, 1, 0, "HLP_ProdutoView.htm");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTxttabtitle_Internalname, lblTxttabtitle_Caption, "", "", lblTxttabtitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockTitleWWPTab", 0, "", 1, 1, 0, "HLP_ProdutoView.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblGeneral_title_Internalname, "General", "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, "HLP_ProdutoView.htm");
            /* Div Control */
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtngeneral_Internalname, "", "General", bttBtngeneral_Jsonclick, 7, "General", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"e110q1_client"+"'", TempTags, "", 2, "HLP_ProdutoView.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void STRUP0Q0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            /* Read saved values. */
            AV9ProdutoId = (short)(context.localUtil.CToN( cgiGet( "vPRODUTOID"), ",", "."));
      ...
      protected void E120Q2( )
      {
         ...
         lblWorkwithlink_Link = formatLink("produtoww.aspx") ;
         context.httpAjaxContext.ajax_rsp_assign_prop("", false, lblWorkwithlink_Internalname, "Link", lblWorkwithlink_Link, true);
         AV14GXLvl9 = 0;
         /* Using cursor H000Q2 */
         pr_default.execute(0, new Object[] {AV9ProdutoId});
         while ( (pr_default.getStatus(0) != 101) )
         {
            A8ProdutoId = H000Q2_A8ProdutoId[0];
            A9ProdutoNome = H000Q2_A9ProdutoNome[0];
            AV14GXLvl9 = 1;
            Form.Caption = A9ProdutoNome;
      ...
      protected void S112( )
      {
         ...
         {
            /* Object Property */
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Generalwc_Component), StringUtil.Lower( "ProdutoGeneral")) != 0 )
            {
               WebComp_Generalwc = getWebComponent(GetType(), "GeneXus.Programs", "produtogeneral", new Object[] {context} );
               WebComp_Generalwc.ComponentInit();
               WebComp_Generalwc.Name = "ProdutoGeneral";
               WebComp_Generalwc_Component = "ProdutoGeneral";
            }
            if ( StringUtil.Len( WebComp_Generalwc_Component) != 0 )
            {
               WebComp_Generalwc.setjustcreated();
               WebComp_Generalwc.componentprepare(new Object[] {(String)"W0026",(String)"",(short)AV9ProdutoId});
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV9ProdutoId = Convert.ToInt16(getParm(obj,0));
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV9ProdutoId", StringUtil.LTrim( StringUtil.Str( (decimal)(AV9ProdutoId), 4, 0)));
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "gxhash_vPRODUTOID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV9ProdutoId), "ZZZ9"), context));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?201971112292958", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("produtoview.js", "?201971112292958", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV9ProdutoId',fld:'vPRODUTOID',pic:'ZZZ9',hsh:true},{av:'AV7TabCode',fld:'vTABCODE',pic:'',hsh:true}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("'GENERAL'","{handler:'E110Q1',iparms:[{av:'AV10LoadAllTabs',fld:'vLOADALLTABS',pic:''},{av:'AV11SelectedTabCode',fld:'vSELECTEDTABCODE',pic:''},{av:'AV9ProdutoId',fld:'vPRODUTOID',pic:'ZZZ9',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         H000Q2_A8ProdutoId = new short[1] ;
         H000Q2_A9ProdutoNome = new String[] {""} ;
         A9ProdutoNome = "";
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.produtoview__default(),
            new Object[][] {
                new Object[] {
               H000Q2_A8ProdutoId, H000Q2_A9ProdutoNome
               }
            }
         );
      ...
      private short AV9ProdutoId ;
      private short wcpOAV9ProdutoId ;
      ...
      private short[] H000Q2_A8ProdutoId ;
      private String[] H000Q2_A9ProdutoNome ;
   ...
   public class produtoview__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new Object[] {"@AV9ProdutoId",SqlDbType.SmallInt,4,0}
          } ;
          def= new CursorDef[] {
              new CursorDef("H000Q2", "SELECT [ProdutoId], [ProdutoNome] FROM [Produto] WHERE [ProdutoId] = @AV9ProdutoId ORDER BY [ProdutoId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000Q2,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
