/*
               File: PessoaView
        Description: Pessoa View
             Author: GeneXus C# Generator version 16_0_2-131213
       Generated on: 7/11/2019 12:29:28.63
...
namespace GeneXus.Programs {
   public class pessoaview : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public pessoaview( )
      {
      ...
      public pessoaview( IGxContext context )
      {
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            {
               AV9PessoaId = (short)(NumberUtil.Val( gxfirstwebparm, "."));
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV9PessoaId", StringUtil.LTrim( StringUtil.Str( (decimal)(AV9PessoaId), 4, 0)));
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "gxhash_vPESSOAID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV9PessoaId), "ZZZ9"), context));
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?201971112292865", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("pessoaview.aspx") + "?" + UrlEncode("" +AV9PessoaId) + "," + UrlEncode(StringUtil.RTrim(AV7TabCode))+"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vPESSOAID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV9PessoaId), 4, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vPESSOAID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV9PessoaId), "ZZZ9"), context));
      ...
      {
         return formatLink("pessoaview.aspx") + "?" + UrlEncode("" +AV9PessoaId) + "," + UrlEncode(StringUtil.RTrim(AV7TabCode)) ;
      }
      ...
      protected void WB0P0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblWorkwithlink_Internalname, "Ir a Pessoa", lblWorkwithlink_Link, "", lblWorkwithlink_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockLink", 0, "", 1, 1, 0, "HLP_PessoaView.htm");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTxttabtitle_Internalname, lblTxttabtitle_Caption, "", "", lblTxttabtitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockTitleWWPTab", 0, "", 1, 1, 0, "HLP_PessoaView.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblGeneral_title_Internalname, "General", "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, "HLP_PessoaView.htm");
            /* Div Control */
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtngeneral_Internalname, "", "General", bttBtngeneral_Jsonclick, 7, "General", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"e110p1_client"+"'", TempTags, "", 2, "HLP_PessoaView.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void START0P2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Pessoa View", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void STRUP0P0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            /* Read saved values. */
            AV9PessoaId = (short)(context.localUtil.CToN( cgiGet( "vPESSOAID"), ",", "."));
      ...
      protected void E120P2( )
      {
         ...
         lblWorkwithlink_Link = formatLink("pessoaww.aspx") ;
         context.httpAjaxContext.ajax_rsp_assign_prop("", false, lblWorkwithlink_Internalname, "Link", lblWorkwithlink_Link, true);
         AV14GXLvl9 = 0;
         /* Using cursor H000P2 */
         pr_default.execute(0, new Object[] {AV9PessoaId});
         while ( (pr_default.getStatus(0) != 101) )
         {
            A1PessoaId = H000P2_A1PessoaId[0];
            AV14GXLvl9 = 1;
            Form.Caption = "Pessoa";
      ...
      protected void S112( )
      {
         ...
         {
            /* Object Property */
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Generalwc_Component), StringUtil.Lower( "PessoaGeneral")) != 0 )
            {
               WebComp_Generalwc = getWebComponent(GetType(), "GeneXus.Programs", "pessoageneral", new Object[] {context} );
               WebComp_Generalwc.ComponentInit();
               WebComp_Generalwc.Name = "PessoaGeneral";
               WebComp_Generalwc_Component = "PessoaGeneral";
            }
            if ( StringUtil.Len( WebComp_Generalwc_Component) != 0 )
            {
               WebComp_Generalwc.setjustcreated();
               WebComp_Generalwc.componentprepare(new Object[] {(String)"W0026",(String)"",(short)AV9PessoaId});
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV9PessoaId = Convert.ToInt16(getParm(obj,0));
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV9PessoaId", StringUtil.LTrim( StringUtil.Str( (decimal)(AV9PessoaId), 4, 0)));
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "gxhash_vPESSOAID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV9PessoaId), "ZZZ9"), context));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?201971112292886", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("pessoaview.js", "?201971112292887", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV9PessoaId',fld:'vPESSOAID',pic:'ZZZ9',hsh:true},{av:'AV7TabCode',fld:'vTABCODE',pic:'',hsh:true}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("'GENERAL'","{handler:'E110P1',iparms:[{av:'AV10LoadAllTabs',fld:'vLOADALLTABS',pic:''},{av:'AV11SelectedTabCode',fld:'vSELECTEDTABCODE',pic:''},{av:'AV9PessoaId',fld:'vPESSOAID',pic:'ZZZ9',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         H000P2_A1PessoaId = new short[1] ;
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.pessoaview__default(),
            new Object[][] {
                new Object[] {
               H000P2_A1PessoaId
               }
      ...
      private short AV9PessoaId ;
      private short wcpOAV9PessoaId ;
      ...
      private short[] H000P2_A1PessoaId ;
   ...
   public class pessoaview__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new Object[] {"@AV9PessoaId",SqlDbType.SmallInt,4,0}
          } ;
          def= new CursorDef[] {
              new CursorDef("H000P2", "SELECT [PessoaId] FROM [Pessoa] WHERE [PessoaId] = @AV9PessoaId ORDER BY [PessoaId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000P2,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
