/*
               File: ParametroView
        Description: Parametro View
             Author: GeneXus C# Generator version 16_0_2-131213
       Generated on: 7/11/2019 20:45:15.50
...
namespace GeneXus.Programs {
   public class parametroview : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      public void execute( short aP0_ParametroID ,
                           String aP1_TabCode )
      {
         this.AV9ParametroID = aP0_ParametroID;
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            {
               AV9ParametroID = (short)(NumberUtil.Val( gxfirstwebparm, "."));
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV9ParametroID", StringUtil.LTrim( StringUtil.Str( (decimal)(AV9ParametroID), 4, 0)));
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "gxhash_vPARAMETROID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV9ParametroID), "ZZZ9"), context));
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?201971120451552", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("parametroview.aspx") + "?" + UrlEncode("" +AV9ParametroID) + "," + UrlEncode(StringUtil.RTrim(AV7TabCode))+"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vPARAMETROID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV9ParametroID), 4, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vPARAMETROID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV9ParametroID), "ZZZ9"), context));
      ...
      {
         return formatLink("parametroview.aspx") + "?" + UrlEncode("" +AV9ParametroID) + "," + UrlEncode(StringUtil.RTrim(AV7TabCode)) ;
      }
      ...
      protected void WB0U0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblWorkwithlink_Internalname, "Ir a Parametro", lblWorkwithlink_Link, "", lblWorkwithlink_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockLink", 0, "", 1, 1, 0, "HLP_ParametroView.htm");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTxttabtitle_Internalname, lblTxttabtitle_Caption, "", "", lblTxttabtitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockTitleWWPTab", 0, "", 1, 1, 0, "HLP_ParametroView.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblGeneral_title_Internalname, "General", "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, "HLP_ParametroView.htm");
            /* Div Control */
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtngeneral_Internalname, "", "General", bttBtngeneral_Jsonclick, 7, "General", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"e110u1_client"+"'", TempTags, "", 2, "HLP_ParametroView.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void STRUP0U0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            /* Read saved values. */
            AV9ParametroID = (short)(context.localUtil.CToN( cgiGet( "vPARAMETROID"), ",", "."));
      ...
      protected void E120U2( )
      {
         ...
         AV14GXLvl9 = 0;
         /* Using cursor H000U2 */
         pr_default.execute(0, new Object[] {AV9ParametroID});
         while ( (pr_default.getStatus(0) != 101) )
         {
            A13ParametroID = H000U2_A13ParametroID[0];
            A14ParametroDtVigenciaIni = H000U2_A14ParametroDtVigenciaIni[0];
            AV14GXLvl9 = 1;
            Form.Caption = context.localUtil.DToC( A14ParametroDtVigenciaIni, 2, "/");
      ...
      protected void S112( )
      {
         ...
         {
            /* Object Property */
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Generalwc_Component), StringUtil.Lower( "ParametroGeneral")) != 0 )
            {
               WebComp_Generalwc = getWebComponent(GetType(), "GeneXus.Programs", "parametrogeneral", new Object[] {context} );
               WebComp_Generalwc.ComponentInit();
               WebComp_Generalwc.Name = "ParametroGeneral";
               WebComp_Generalwc_Component = "ParametroGeneral";
            }
            if ( StringUtil.Len( WebComp_Generalwc_Component) != 0 )
            {
               WebComp_Generalwc.setjustcreated();
               WebComp_Generalwc.componentprepare(new Object[] {(String)"W0026",(String)"",(short)AV9ParametroID});
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV9ParametroID = Convert.ToInt16(getParm(obj,0));
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV9ParametroID", StringUtil.LTrim( StringUtil.Str( (decimal)(AV9ParametroID), 4, 0)));
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "gxhash_vPARAMETROID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV9ParametroID), "ZZZ9"), context));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?201971120451578", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("parametroview.js", "?201971120451579", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV9ParametroID',fld:'vPARAMETROID',pic:'ZZZ9',hsh:true},{av:'AV7TabCode',fld:'vTABCODE',pic:'',hsh:true}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("'GENERAL'","{handler:'E110U1',iparms:[{av:'AV10LoadAllTabs',fld:'vLOADALLTABS',pic:''},{av:'AV11SelectedTabCode',fld:'vSELECTEDTABCODE',pic:''},{av:'AV9ParametroID',fld:'vPARAMETROID',pic:'ZZZ9',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         H000U2_A13ParametroID = new short[1] ;
         H000U2_A14ParametroDtVigenciaIni = new DateTime[] {DateTime.MinValue} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.parametroview__default(),
            new Object[][] {
                new Object[] {
               H000U2_A13ParametroID, H000U2_A14ParametroDtVigenciaIni
               }
            }
         );
      ...
      private short AV9ParametroID ;
      private short wcpOAV9ParametroID ;
      ...
      private short[] H000U2_A13ParametroID ;
      private DateTime[] H000U2_A14ParametroDtVigenciaIni ;
   ...
   public class parametroview__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new Object[] {"@AV9ParametroID",SqlDbType.SmallInt,4,0}
          } ;
          def= new CursorDef[] {
              new CursorDef("H000U2", "SELECT [ParametroID], [ParametroDtVigenciaIni] FROM [Parametro] WHERE [ParametroID] = @AV9ParametroID ORDER BY [ParametroID] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000U2,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
